...
const INTL_DATA_TRANSFERS: Paragraph = {
    ...
    text: [
        `Datenverarbeitung in Drittländern: Sofern wir Daten in einem Drittland (d. h., außerhalb der Europäischen Union
        ...
        `EU-US Trans-Atlantic Data Privacy Framework: Im Rahmen des sogenannten „Data Privacy Framework" (DPF) hat die
            ...
            auch weitere Informationen zu dem DPF können Sie der Webseite des Handelsministeriums der USA unter `,
...
const DATA_DELETION: Paragraph = {
    ...
    text: [
        `Die von uns verarbeiteten Daten werden nach Maßgabe der gesetzlichen Vorgaben gelöscht, sobald deren zur
            ...
            Rechte einer anderen natürlichen oder juristischen Person erforderlich ist. Unsere Datenschutzhinweise können
            ferner weitere Angaben zu der Aufbewahrung und Löschung von Daten beinhalten, die für die jeweiligen
...
const COOKIES: Paragraph = {
    ...
    text: [
        ...
        `Wir setzen Cookies im Einklang mit den gesetzlichen Vorschriften ein.
            ...
            deutlich kommuniziert und enthält die Informationen zu der jeweiligen Cookie-Nutzung.`,
...
const WEB_HOSTING: Paragraph = {
    title: `Bereitstellung des Onlineangebotes und Webhosting`,
    text: [
        ...
        `Der Zugriff auf unser Onlineangebot wird in Form
...
const PLUGINS: Paragraph = {
    title: `Plugins und eingebettete Funktionen sowie Inhalte`,
    text: [
...
const PRIVACY_UPDATE: Paragraph = {
    title: `Änderung und Aktualisierung der Datenschutzerklärung`,
    text: [
